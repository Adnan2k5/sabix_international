...
export const categories = [
  ...
  },
  {
    ...
    slug: '/spare-parts',
    title: 'Spare Parts',
    subtitle: 'Genuine and aftermarket spare parts for heavy trucks and trailers.',
    description:
      'SABIX sources and supplies spare parts for heavy trucks and trailers — specialising in Volvo and Mercedes-Benz components to keep your fleet operational and on the road.',
    image: '/assets/images/spare-parts.jpg',
    imageAlt: 'Heavy truck spare parts — Volvo and Mercedes-Benz components',
    accentLabel: 'Trucks · Trailers · Volvo · Mercedes',
    families: [
      {
        id: 'engine-parts',
        name: 'Engine & Drivetrain Parts',
        description: 'Engine components, gearbox parts, and drivetrain spares for Volvo and Mercedes-Benz trucks.',
      },
      {
        id: 'brake-suspension',
        name: 'Brake & Suspension Parts',
        description: 'Brake discs, pads, calipers, shock absorbers and suspension components for heavy trucks and trailers.',
      },
      {
        id: 'electrical-parts',
        name: 'Electrical & Filters',
        description: 'Sensors, filters, lighting components and electrical parts for Volvo and Mercedes-Benz commercial vehicles.',
      },
      {
        id: 'trailer-parts',
        name: 'Trailer Components',
        description: 'Landing gear, kingpins, fifth wheels, axle parts and body components for trailers.',
      },
    ],
  },
];
