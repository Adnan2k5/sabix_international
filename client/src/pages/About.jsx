  ...
  return (
    <>
        ...
        <div className="container section-padding">
          <FadeIn className="mb-14">
            <SectionHeading
              ...
              title={t(about.approach.headline)}
              maxWidth="40ch"
            />
          </FadeIn>
            ...
            {about.approach.items.map((item, i) => (
              <FadeIn key={item.number} delay={i * 0.05}>
                ...
                >
                  ...
                  <h3 className="text-subheading font-semibold text-base">{t(item.title)}</h3>
                  <p className="text-sm text-[var(--color-muted)] leading-relaxed">{t(item.body)}</p>
                </div>
              </FadeIn>
            ))}
          </div>
      ...
      <section className="section-border-top" style={{ backgroundColor: 'var(--color-primary)' }}>
        <div className="container section-padding">
          <FadeIn className="mb-14">
            <SectionHeading
              eyebrow={t("Presence")}
              title={t("International. Based in Riyadh.")}
              description={t("Headquartered in Saudi Arabia with offices in the United States and India — enabling SABIX to source across global networks and serve customers across international markets.")}
            />
          </FadeIn>
              ...
              <FadeIn key={i} delay={i * 0.07}>
                <div className="p-10 flex flex-col gap-2" style={{ backgroundColor: i === 0 ? 'rgba(232,117,36,0.1)' : 'transparent' }}>
                  ...
                  <p className="text-sm" style={{ color: 'rgba(255,255,255,0.45)' }}>
                    {t(loc.country)}
                    {loc.label === 'Headquarters' ? ` — ${t("HQ")}` : ` — ${t("Branch")}`}
                  </p>
                </div>
              </FadeIn>
            ))}
      ...
      <section className="section-border-top" style={{ backgroundColor: 'var(--color-background)' }}>
        <div className="container section-padding">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <FadeIn>
              <SectionHeading
                eyebrow={t(about.partnership.eyebrow)}
                title={t(about.partnership.headline)}
                description={t(about.partnership.body)}
              />
            </FadeIn>
            <FadeIn delay={0.1}>
              <div
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-meta">{t("LAVAAL International")}</p>
                  <p className="text-[10px] text-[var(--color-muted)] mt-1">
                    {t("[Replace with official logo — update company.js]")}
                  </p>
                </div>
              </div>
            </FadeIn>
      ...
      <CTASection
        ...
        headline={t("Have a supply requirement?")}
        body={t("Contact our team. We will work with you to understand your requirement and provide the appropriate supply solution.")}
        primaryLabel={t("Request a Quote")}
        primaryTo="/contact"
        secondaryLabel={t("Explore products")}
